...
To save results in memory (Database, File, Preferences), the user will not need to input values after killing and reopening the application. (Use shared_preferences for storing data).